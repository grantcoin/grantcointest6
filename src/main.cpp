...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 22);  // Reduced initial difficulty from Peercoin's 32
static CBigNum bnInitialHashTarget(~uint256(0) >> 22);  // Reduced from Peercoin's 40
